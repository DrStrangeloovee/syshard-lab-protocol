...
- _Greenbone Community Edition OpenVAS_#footnote("https://community.greenbone.net/") is a full-featured vulnerability scanner based off feeds containing known vulnerabilities.
...
+ _Missing Linux Kernel mitigations for 'SSB - Speculative Store Bypass' hardware vulnerabilities_#footnote("https://pentest-tools.com/vulnerabilities-exploits/missing-linux-kernel-mitigations-for-ssb-speculative-store-bypass-hardware-vulnerabilities_9991")
+ _Debian: Security Advisory (DSA-5931-1)_#footnote("https://lists.debian.org/debian-security-announce/2025/msg00095.html")
